 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{}linked_position" maxOccurs="2"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class LinkedPositions {
    ...
    @XmlElement(name = "linked_position", required = true)
    protected List<LinkedPosition> linkedPosition;

    /**
     * A linked position in a peptide. A looplinked peptide will have two linked positions. A crosslinked peptide will have one (on each linked peptide).Gets the value of the linkedPosition property.
     * 
     * <p>
